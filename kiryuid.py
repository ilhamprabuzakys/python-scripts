...
if args.start == args.end:
    ...
    print(
        f"\n==============================================================================================================================\nMendownload Chapter {colored(f'{args.start}', 'green')} sampai {colored(f'{args.end}', 'green')} \n=============================================================================================================================="
    )
...
for chapter in filtered_chapters:
    ...
    # images = [img for img in soup.find_all('img', class_="ts-main-image curdown") if valid_image(img.get('src'))]
    # images = [img for img in soup.find_all('img', class_=["ts-main-image", "curdown"]) if valid_image(img.get('src'))]
    pbar = tqdm(
...
if args.start == args.end:
    print(
        f"\n==============================================================================================================================\nAll Pages from chapter {colored(f'{args.start}', 'red')} has been downloaded..\n=============================================================================================================================="
    )
else:
    print(
...
print(
    f"\n[{colored('Total time taken to download chapters:', 'white')} {colored(f'{end_time - start_time:.2f}', 'white')} seconds]"
)
